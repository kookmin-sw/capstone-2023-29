...
function BusNumListBackUp(){
    ...
    async function handleGetBusListbyName() {
      ...
      async function handleStarButtonClick(busId, busStation) {
                ...
                <tr key={index}>
                  ...
                  <td>
                    <img 
                      ...
                      style={{maxWidth:'25px'}}
                      onClick={()=>{
                        handleStarButtonClick(busIdListArr[index], busStationArr[index])
                      }}
                    />
                  </td>
              </tr>
...
export default BusNumListBackUp;